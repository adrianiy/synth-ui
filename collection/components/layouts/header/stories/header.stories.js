...
const Template = ({ interface: interfaceValue, appData, menu, search, share, brand, brandList, timeline, notifications, calendarEvents, activeBrand, appTitle, appSubtitle, userMenuConfig, avatar, userData, }, ctx) => WithGlobalDecorator({
...
WithSubtitle.args = Object.assign(Object.assign({}, baseProps), { appSubtitle: 'test app' });
export const Redesign = Template.bind({});
Redesign.args = Object.assign(Object.assign({}, baseProps), { interface: "redesign" /* redesign */ });
