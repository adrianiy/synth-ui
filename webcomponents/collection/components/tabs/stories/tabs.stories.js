...
const Template = ({ tabs, tabStyle }, ctx) => WithGlobalDecorator({
...
SmallTabs.args = Object.assign({}, baseProps);
export const BigTabs = Template.bind({});
BigTabs.args = Object.assign(Object.assign({}, baseProps), { tabStyle: 'big' });
