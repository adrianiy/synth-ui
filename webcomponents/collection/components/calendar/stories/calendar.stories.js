...
const Template = ({ minDate, maxDate, startDate, endDate, singleSelect, months, auxActive, secondary, startDateAux, endDateAux, minDateAux, maxDateAux, }, ctx) => WithGlobalDecorator({
...
WithSingleSelection.args = Object.assign(Object.assign({}, baseProps), { singleSelect: true });
export const WithMultipleRanges = Template.bind({});
WithMultipleRanges.args = Object.assign(Object.assign({}, baseProps), { startDateAux,
  endDateAux,
  minDateAux,
  maxDateAux, auxActive: true });
export const WithSecondarySelection = Template.bind({});
WithSecondarySelection.args = Object.assign(Object.assign({}, baseProps), { startDateAux,
  endDateAux,
  minDateAux,
  maxDateAux, auxActive: true, secondary: true });
