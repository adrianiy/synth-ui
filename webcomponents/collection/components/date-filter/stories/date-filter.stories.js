...
const Template = ({ minDate, maxDate, minComparableDate, maxComparableDate, options, description, active, comparableOptions, interface: interfaceValue, }, ctx) => WithGlobalDecorator({
