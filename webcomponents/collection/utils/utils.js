...
export const getComponentClosestLanguage = (element) => {
...
export const getComponentLocale = (element, languages) => {
  const language = getComponentClosestLanguage(element);
  return languages[language];
};
export async function getLocaleComponentStrings(requiredI18n, element, basePath, locale) {
...
export const getFormatedValues = (cell) => {
