...
const _applyDateFilter = (
    ...
    if (dateRange) {
        return addNewFilter(dateFilter, { description: dateRange, startDate, endDate } as any, false);
    } else {
        ...
        return addNewFilter(dateFilter, { description: `${startDate} - ${endDate}`, startDate, endDate } as any, false);
    }
};
