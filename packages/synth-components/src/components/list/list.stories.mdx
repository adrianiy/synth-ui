...
export const Template = (args) => html`<div style="width: 300px;"><synth-list .data=${args.data} limit=${args.limit} loading=${args.loading} enable-download=${args.enableDownload} expandable=${args.expandable} /> </div>`;
