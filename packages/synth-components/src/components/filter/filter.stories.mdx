...
export const Template = args => html`<div style="width: 300px; height: 250px"><synth-filter ...=${spread(args)} @optionClickEvent=${optionClickEvent} @clearEvent=${clearEvent} @multiSelectEvent=${multiSelectEvent} /></div>`;
