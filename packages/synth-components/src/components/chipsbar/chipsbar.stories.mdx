...
export const Template = args => html`<synth-chipsbar .filtersConfig=${args.filtersConfig} @filterSelect=${optionClickEvent} @filterClear=${clearEvent} @filterMultiSelect=${multiSelectEvent} />`;
