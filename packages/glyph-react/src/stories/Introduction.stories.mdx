...
3. Execute `yarn build` script to copy assets in static folder

```bash
yarn build
```

4. Use glyph-components wherever you like to.
...
1. Import assets dir from `node_modules/glyph_react/dist/assets` in your local assets.
...
2. Execute `yarn build` in frontend folder
