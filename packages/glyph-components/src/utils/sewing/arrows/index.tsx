...
const SewingIcon: FunctionalComponent<SewingIconProps> = ({ icon, ...props }: SewingIconProps) => {
    if (props.icon === "arrow-circle-left-filled") {
        return (
    ...
    if (props.icon === "arrow-circle-left-outlined") {
        return (
            <svg width="1em" height="1em" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
                <path
    ...
    if (props.icon === "arrow-circle-right-filled") {
        return (
            <svg width="1em" height="1em" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
                <path
                    fillRule="evenodd"
    ...
    if (props.icon === "arrow-circle-right-outlined") {
        return (
            <svg width="1em" height="1em" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
                <path
    ...
    if (props.icon === "arrow-circle-up-filled") {
        return (
            <svg width="1em" height="1em" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
                <path
                    fillRule="evenodd"
    ...
    if (props.icon === "arrow-circle-up-outlined") {
        return (
            <svg width="1em" height="1em" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
                <path
    ...
    if (props.icon === "arrown-circle-down-filled") {
        return (
            <svg width="1em" height="1em" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
                <path
                    fillRule="evenodd"
    ...
    if (props.icon === "arrown-circle-down-outlined") {
        return (
            <svg width="1em" height="1em" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
                <path
    ...
    if (props.icon === "double-chevron-left") {
        return (
            <svg width="1em" height="1em" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
                <path
                    fillRule="evenodd"
    ...
    if (props.icon === "double-chevron-right") {
        return (
            <svg width="1em" height="1em" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
                <path
                    fillRule="evenodd"
    ...
    if (props.icon === "long-arrown-right") {
        return (
            <svg width="1em" height="1em" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
                <path
