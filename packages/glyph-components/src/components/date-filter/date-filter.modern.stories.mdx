...
export const Template = args => html`<div style="width: 400px; height: 550px"><glyph-date-filter ...=${spread(args)} @dateSelection=${optionClickEvent} @clearEvent=${clearEvent} interface="modern" /></div>`;
