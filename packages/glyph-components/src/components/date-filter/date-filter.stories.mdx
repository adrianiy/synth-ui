...
export const Template = args => html`<div style="width: 400px; height: 550px"><glyph-date-filter ...=${spread(args)} @dateSelection=${optionClickEvent} @comparableDateSelection=${comparableEvent} @comparableChange=${comparableChange} @clearEvent=${clearEvent} /></div>`;
