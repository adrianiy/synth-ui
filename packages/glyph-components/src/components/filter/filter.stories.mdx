...
export const Template = args => html`<div style="width: 300px; height: 350px"><glyph-filter ...=${spread(args)} @optionClickEvent=${optionClickEvent} @clearEvent=${clearEvent} @multiSelectEvent=${multiSelectEvent} /></div>`;
