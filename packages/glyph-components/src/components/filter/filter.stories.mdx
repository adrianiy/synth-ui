...
export const Template = args => html`<div style="width: 300px; height: 350px"><glyph-filter ...=${spread(args)} active=false @optionClickEvent=${optionClickEvent} @clearEvent=${clearEvent} @multiSelectEvent=${multiSelectEvent} /></div>`;

<Meta title="Components/Filter/Classic" parameters={{ viewMode: 'docs' }} />
...
export const clearEvent = (event) => {
    ...
    event.target.description = filter.description;
}
