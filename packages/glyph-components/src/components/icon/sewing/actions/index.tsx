...
export const ActionSewingIcon: FunctionalComponent<SewingIconProps> = ({ icon, button, ...props }: SewingIconProps) => {
    ...
    if (icon === 'add-square-outlined') {
        return (
            ...
            >
                <path d="M9.5 14v-3.5H6v-1h3.5V6h1v3.5H14v1h-3.5V14h-1z" fill="#FF8000" />
                <path fill-rule="evenodd" clip-rule="evenodd" d="M2 18V2h16v16H2zM3 3h14v14H3V3z" fill="#FF8000" />
            </svg>
        );
    }
    if (icon === 'add') {
    ...
    if (icon === 'save') {
        return (
            <svg
                ...
                role={button && 'button'}
            >
                <path fill-rule="evenodd" clip-rule="evenodd" d="M5 9v6h10V9H5zm9 1H6v4h8v-4z" fill="#FF8000" />
                <path
                    fill-rule="evenodd"
                    clip-rule="evenodd"
        ...
        return (
            ...
            >
                <path
                    ...
                    fill="#FF8000"
                />
                <path fill-rule="evenodd" clip-rule="evenodd" d="M14 10.5H6v-1h8v1z" fill="#FF8000" />
            </svg>
        );
    }
    if (icon === 'subtract-square-filled') {
        return (
            <svg
                ...
                role={button && 'button'}
            >
                <path fill-rule="evenodd" clip-rule="evenodd" d="M18 2H2v16h16V2zM6 10.5h8v-1H6v1z" fill="#FF8000" />
            </svg>
        );
    }
    ...
    if (icon === 'subtract') {
        return (
            <svg
                ...
                role={button && 'button'}
            >
                <path fill-rule="evenodd" clip-rule="evenodd" d="M18 10.5H2v-1h16v1z" fill="#FF8000" />
            </svg>
        );
    }
