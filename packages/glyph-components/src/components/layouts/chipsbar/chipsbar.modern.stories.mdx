...
export const Template = args => html`<div style="min-height: 200px"><glyph-chipsbar .filtersConfig=${args.filtersConfig} interface='modern' @filterSelect=${optionClickEvent} @dateSelection=${dateSelect} @comparableDateSelection=${compDateSelect} @comparableChange=${comparableChange} @filterClear=${clearEvent} @updateFilter=${multiSelectEvent} @clearAll=${clearAllEvent} /></div>`;
