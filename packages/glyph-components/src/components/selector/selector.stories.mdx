...
export const Template = args => html`<div style="height: 200px"><glyph-selector ...=${spread(args)} @optionSelect=${changeEvent} /></div>`;
export const ComplexTemplate = args => html`<div style="height: 200px"><glyph-selector ...=${spread(args)} @optionSelect=${changeEventComplex} /></div>`;

<Meta title="Components/Selector/Classic" parameters={{ viewMode: 'docs' }} />
...
<Canvas>
    <Story name="Complex" args={{ 'multi-select': true, label: 'simple', '.complexOptions': { group1: [{ name: 'option 1', active: false, value: 1 }, { name: 'option 2', active: false, value: 2 }],
group2: [{ name: 'option 3', active: false, value: 3 }, { name: 'option 4', active: false, value: 4 }]} }}>
