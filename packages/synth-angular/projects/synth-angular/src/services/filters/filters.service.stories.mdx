...
import { SynthFilterService } from './filters.service.ts'

<Meta
    title="Services/Filters"
    component={ SynthFilterService }
/>
...
All logic implementation will lay on *synth-core* vanilla javascript functions.
...
<ArgsTable of={SynthFilterService}/>
