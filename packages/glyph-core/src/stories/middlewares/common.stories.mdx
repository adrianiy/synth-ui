...
- **endpoints**: And object with a path for each entity you want to consult. i.e: /api/v1/entities/section

> If you pass an object with values it will override global endpoints. This is usefull to avoid fetching some entity (with a null value) if you don't need it as filter.
