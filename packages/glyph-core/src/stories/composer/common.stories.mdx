...
This is an example of a pipe to get filter entites from WSC. You can use [fetchFiltersConfig](?path=/docs/middlewares-common--filters) middleware instead.
...
import { composer, sortCountries } from 'glyph-core';
